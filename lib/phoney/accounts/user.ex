defmodule Phoney.Accounts.User do
  use Ash.Resource,
    otp_app: :phoney,
    domain: Phoney.Accounts,
  ...
  authentication do
    tokens do
      enabled? true
      token_resource Phoney.Accounts.Token
      signing_secret Phoney.Secrets
    ...
    strategies do
      password :password do
        ...
        resettable do
          sender Phoney.Accounts.User.Senders.SendPasswordResetEmail
    ...
    add_ons do
      confirmation :confirm_new_user do
        ...
        sender Phoney.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end
  end
